...
#define imu_spi_chip_select() spi1_chip_select_pin(IMU_CS)
#define imu_spi_chip_deselect() spi1_chip_deselect_pin(IMU_CS)

#define barometer_spi_read_write    spi1_read_write //XXX: barometer's porting is not complete
#define barometer_spi_chip_select()   spi1_chip_select_pin(BARO_CS)
#define barometer_spi_chip_deselect() spi1_chip_deselect_pin(BARO_CS)
