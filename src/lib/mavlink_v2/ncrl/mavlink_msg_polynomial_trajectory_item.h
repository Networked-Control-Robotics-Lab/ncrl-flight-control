...
#define MAVLINK_MSG_ID_POLYNOMIAL_TRAJECTORY_ITEM_LEN 130
#define MAVLINK_MSG_ID_POLYNOMIAL_TRAJECTORY_ITEM_MIN_LEN 130
#define MAVLINK_MSG_ID_11003_LEN 130
#define MAVLINK_MSG_ID_11003_MIN_LEN 130

#define MAVLINK_MSG_ID_POLYNOMIAL_TRAJECTORY_ITEM_CRC 138
#define MAVLINK_MSG_ID_11003_CRC 138
...
static inline uint16_t mavlink_msg_polynomial_trajectory_item_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, const float *x_coeff, const float *y_coeff, const float *z_coeff, const float *yaw_coeff)
{
...
static inline void mavlink_msg_polynomial_trajectory_item_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const float *x_coeff, const float *y_coeff, const float *z_coeff, const float *yaw_coeff)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_POLYNOMIAL_TRAJECTORY_ITEM_LEN];
    _mav_put_uint8_t(buf, 128, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_polynomial_trajectory_item_send(chan, polynomial_trajectory_item->target_system, polynomial_trajectory_item->target_component, polynomial_trajectory_item->x_coeff, polynomial_trajectory_item->y_coeff, polynomial_trajectory_item->z_coeff, polynomial_trajectory_item->yaw_coeff);
#else
 ...
 */
static inline void mavlink_msg_polynomial_trajectory_item_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, const float *x_coeff, const float *y_coeff, const float *z_coeff, const float *yaw_coeff)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
