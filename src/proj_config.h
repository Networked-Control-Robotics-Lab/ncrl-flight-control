...
/* feedforward control for tracking control */
#define FEEDFORWARD_TRACKING_USE_GEOMETRY 0
#define FEEDFORWARD_TRACKING_USE_ADAPTIVE_ICL 1
#define SELECT_FEEDFORWARD_TRACKING FEEDFORWARD_TRACKING_USE_GEOMETRY
