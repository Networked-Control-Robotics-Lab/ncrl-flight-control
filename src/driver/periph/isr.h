...
#define SW_I2C_TIMER_ISR_PRIORITY (configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY + 1)
#define IMU_EXTI_ISR_PRIORITY (configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY + 1)
#define GPS_OPTITRACK_UART_ISR (configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY + 2)
#define GPS_UART_TX_ISR (configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY + 2)
#define SBUS_ISR_PRIORITY (configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY + 3)
