...
void madgwick_imu_ahrs(madgwick_t *madgwick, float *accel, float *gyro)
{
	...
	float q2_dot = 0.5f * (madgwick->q[0] * gyro[1] - madgwick->q[1] * gyro[2] + madgwick->q[3] * gyro[0]);
	float q3_dot = 0.5f * (madgwick->q[0] * gyro[2] + madgwick->q[1] * gyro[1] - madgwick->q[2] * gyro[0]);
	...
	float g1 = _4q1*q1q1_q2q2 - _2q3*accel[0] - _2q0*accel[1] + _4q1*accel[2];
	float g2 = _4q2*q1q1_q2q2 + _2q0*accel[0] - _2q3*accel[1] + _4q2*accel[2];
...
void madgwick_margs_ahrs(madgwick_t *madgwick, float *accel, float *gyro, float *mag)
{
	...
	float mag_norm;
	arm_sqrt_f32(mag[0]*mag[0] + mag[1]*mag[1] + mag[2]*mag[2], &mag_norm);
	...
	float hx = mag[0]*q0q0 - _2q0my*madgwick->q[3] + _2q0mz*madgwick->q[2] +
	           mag[0]*q1q1 + _2q1*mag[1]*madgwick->q[2] + _2q1*mag[2]*madgwick->q[3] - mag[0]*q2q2 - mag[0]*q3q3;
	float hy = _2q0mx*madgwick->q[3] + mag[1]*q0q0 - _2q0mz*madgwick->q[1] +
	           _2q1mx*madgwick->q[2] - mag[1]*q1q1 + mag[1]*q2q2 + _2q2*mag[2]*madgwick->q[3] - mag[1]*q3q3;
	float _2bx;
	arm_sqrt_f32(hx*hx + hy*hy, &_2bx);
	float _2bz = -_2q0mx*madgwick->q[2] + _2q0my*madgwick->q[1] + mag[2]*q0q0 +
	             _2q1mx*madgwick->q[3] - mag[2]*q1q1 + _2q2*mag[1]*madgwick->q[3] - mag[2]*q2q2 + mag[2]*q3q3;
	float _4bx = 2.0f * _2bx;
	float _4bz = 2.0f * _2bz;

	/* gradient decent algorithm corrective step */
	float g0 = _4q0*q1q1_q2q2 + _2q2*accel[0] - _2q1*accel[1] -
	           _2bz*madgwick->q[2]*(_2bx*(0.5f-q2q2-q3q3)+_2bz*(q1q3-q0q2)-mag[0]) +
	           (-_2bx*madgwick->q[3]+_2bz*madgwick->q[1])*(_2bx*(q1q2-q0q3)+_2bz*(q0q1+q2q3)-mag[1]) +
	           _2bx*madgwick->q[2]*(_2bx*(q0q2+q1q3) + _2bz*(0.5f-q1q1-q2q2)-mag[2]);
	float g1 = _4q1*q1q1_q2q2 - _2q3*accel[0] - _2q0*accel[1] + _4q1*accel[2] +
	           _2bz*madgwick->q[3]*(_2bx*(0.5f-q2q2-q3q3)+_2bz*(q1q3-q0q2)-mag[0]) +
	           (_2bx*madgwick->q[2]+_2bz*madgwick->q[0])*(_2bx*(q1q2-q0q3)+_2bz*(q0q1+q2q3)-mag[1]) +
	           (_2bx*madgwick->q[3]-_4bz*madgwick->q[1])*(_2bx*(q0q2+q1q3) + _2bz*(0.5f-q1q1-q2q2)-mag[2]);
	float g2 = _4q2*q1q1_q2q2+_2q0*accel[0] - _2q3*accel[1] + _4q2*accel[2] +
	           (-_4bx*madgwick->q[2]-_2bz*madgwick->q[0])*(_2bx*(0.5f-q2q2-q3q3) +
	                           _2bz*(q1q3-q0q2)-mag[0])+(_2bx*madgwick->q[1]+_2bz*madgwick->q[3])*(_2bx*(q1q2-q0q3)+_2bz*(q0q1+q2q3)-mag[1]) +
	           (_2bx*madgwick->q[0]-_4bz*madgwick->q[2])*(_2bx*(q0q2+q1q3)+_2bz*(0.5f-q1q1-q2q2)-mag[2]);
	float g3 = _4q3*q1q1_q2q2 - _2q1*accel[0] - _2q2*accel[1] +
	           (-_4bx*madgwick->q[3]+_2bz*madgwick->q[1])*(_2bx*(0.5f-q2q2-q3q3)+_2bz*(q1q3-q0q2)-mag[0]) +
	           (-_2bx*madgwick->q[0]+_2bz*madgwick->q[2])*(_2bx*(q1q2-q0q3)+_2bz*(q0q1+q2q3)-mag[1]) +
	           _2bx*madgwick->q[1]*(_2bx*(q0q2+q1q3) + _2bz*(0.5f-q1q1-q2q2)-mag[2]);
