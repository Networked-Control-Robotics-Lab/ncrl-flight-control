...
enum {
	...
	MESSAGE_ID_ICL_THETA_M = 31,
	MESSAGE_ID_ICL_THETA_M_DOT = 32,
	MESSAGE_ID_ICL_THETA_M_DOT_ADAPTIVE = 33,
	MESSAGE_ID_ICL_THETA_M_DOT_ICL = 34,
	MESSAGE_ID_ICL_THETA_DIAG = 35,
	MESSAGE_ID_ICL_THETA_DIAG_DOT = 36,
	MESSAGE_ID_ICL_THETA_DIAG_DOT_ADAPTIVE = 37,
	MESSAGE_ID_ICL_THETA_DIAG_DOT_ICL = 38
} MESSAGE_ID;
